cmd_board/samsung/fs2416/lowlevel_init.o := arm-none-linux-gnueabi-gcc -Wp,-MD,board/samsung/fs2416/.lowlevel_init.o.d  -nostdinc -isystem /home/damien/prj-odf/cross-compile/arm-4.3.2/bin/../lib/gcc/arm-none-linux-gnueabi/4.3.2/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -D__ASSEMBLY__ -g -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv5te -D__LINUX_ARM_ARCH__=5   -c -o board/samsung/fs2416/lowlevel_init.o board/samsung/fs2416/lowlevel_init.S

source_board/samsung/fs2416/lowlevel_init.o := board/samsung/fs2416/lowlevel_init.S

deps_board/samsung/fs2416/lowlevel_init.o := \
  include/config.h \
...
board/samsung/fs2416/lowlevel_init.o: $(deps_board/samsung/fs2416/lowlevel_init.o)
